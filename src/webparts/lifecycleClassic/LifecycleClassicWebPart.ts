...
export default class LifecycleClassicWebPart extends BaseClientSideWebPart<ILifecycleClassicWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ILifecycleClassicProps> = React.createElement(
      LifecycleClassic,
      {
